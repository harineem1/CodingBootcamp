...
public class ConsoleDaoJdbcTemplateImpl implements ConsoleDao{
    ...
    private static  final String SELECT_CONSOLE_SQL_BY_MANUFACTURER =
    ...
    public List<Console> getConsoleByManufacturer(String manufacturer) {
        ...
        return jdbcTemplate.query(SELECT_CONSOLE_SQL_BY_MANUFACTURER, this::mapRowToConsole, manufacturer);
    }
